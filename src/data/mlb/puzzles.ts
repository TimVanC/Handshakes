...
export const mlbPuzzles: Puzzle[] = [
  ...
  {
    // Puzzle 17 — Nelson Cruz: the Boomstick. Eight stops, and the power
    // aged like wine — 40+ HR seasons in Baltimore and Seattle, still
    // mashing at 40 in Minnesota.
    id: 17,
    pathType: "team",
    answer: "Nelson Cruz",
  ...
  {
    // Puzzle 18 — Bartolo Colón: Big Sexy. 21 seasons, 13 stints, #40 at
    // every single stop. The Anaheim→Los Angeles rename splits his Angels
    // years (Cy Young in the LA half); the Expos cameo is the 2002
    // blockbuster that cost Montreal Sizemore, Lee and Phillips.
    id: 18,
    pathType: "team",
  ...
  {
    // Puzzle 19 — Curtis Granderson: 23 triples in '07 Detroit, 40-homer
    // Bronx power, then a Queens encore and three quick farewells.
    id: 19,
    pathType: "team",
